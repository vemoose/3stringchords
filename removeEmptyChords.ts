...
const filteredChords = CHORDS.filter(c => c.variations.length > 0);

console.log(`Original chords: ${CHORDS.length}, Filtered: ${filteredChords.length}`);
...
export const CHORDS: Chord[] = ${JSON.stringify(filteredChords, null, 2)};
`;
